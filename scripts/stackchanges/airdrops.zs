...
val stackminecraft1 = [
<air_support:utility_crate>, <air_support:medical_crate>, <air_support:livestock_crate>, <air_support:utility_crate_drop_remote>, <air_support:medical_crate_drop_remote>, <air_support:crate_drop_remote>
] as IItemStack[];

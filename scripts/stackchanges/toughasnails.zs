...
<toughasnails:jelled_slime>, <toughasnails:charcoal_filter>, <toughasnails:magma_shard>, <toughasnails:ice_cube>
] as IItemStack[];
...
val stackminecraft2 = [
<toughasnails:rain_collector>, <toughasnails:campfire>, <toughasnails:temperature_coil:1>, <toughasnails:temperature_coil>
] as IItemStack[];

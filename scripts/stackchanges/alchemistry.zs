...
val stackminecraft2 = [
<alchemistry:electrolyzer>, <alchemistry:chemical_dissolver>, <alchemistry:chemical_combiner>, <alchemistry:evaporator>, <alchemistry:atomizer>, <alchemistry:liquifier>
] as IItemStack[];

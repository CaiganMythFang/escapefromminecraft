...
val stackminecraft2 = [
<wearables:wearable_fabricator>, <wearables:wearable_colouriser>, <wearables:wearable_assembler>, <wearables:display_mannequin_item>, <wearables:mannequin_head_stand>
] as IItemStack[];

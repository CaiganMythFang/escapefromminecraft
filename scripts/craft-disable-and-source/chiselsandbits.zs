...
val lootpurchase = [
<chiselsandbits:chisel_stone:*>, <chiselsandbits:wrench_wood>, <chiselsandbits:chisel_iron:*>, <chiselsandbits:tape_measure>, <chiselsandbits:bittank>, <chiselsandbits:chisel_gold:*>, <chiselsandbits:chisel_diamond:*>, <chiselsandbits:bitsaw_diamond:*>, <chiselsandbits:bit_bag>
] as IItemStack[];
...
//loot, purchase SPECIAL CRAFT DISABLE

val lootpurchasespecial = [
<chiselsandbits:mirrorprint>, <chiselsandbits:negativeprint>, <chiselsandbits:positiveprint>
] as IItemStack[];
for item in lootpurchasespecial {
    item.addTooltip(format.darkPurple(format.bold("TAG : ")) + format.gray("Loot, ") + format.gold("Purchase"));
    item.addTooltip(format.darkGreen("Trader : ") + format.green("Emporium"));
    <ore:fleamarketable>.add(item);
}

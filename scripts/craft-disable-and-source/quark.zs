...
val lootpurchase = [
<quark:soul_powder>, <quark:horse_whistle:*>, <quark:trowel:*>, <quark:pipe>, <quark:chute>, <quark:redstone_randomizer>, <quark:rain_detector>, <quark:ender_watcher>, <quark:elder_sea_lantern>, <quark:blaze_lantern>, <quark:paper_lantern>, <quark:pickarang:*>
] as IItemStack[];
...
val loot = [
<quark:crystal>, <quark:crystal:2>, <quark:crystal:3>, <quark:crystal:4>, <quark:crystal:5>, <quark:crystal:6>, <quark:crystal:7>, <quark:crystal:1>, <quark:root>, <quark:root_flower>, <quark:root_flower:2>, <quark:root_flower:1>, <quark:glowshroom>, <quark:backpack:*>
] as IItemStack[];
for item in loot {
    recipes.remove(item);

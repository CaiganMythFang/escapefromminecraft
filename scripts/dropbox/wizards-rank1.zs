...
val wizardpsidust1 = mods.modularmachinery.RecipeBuilder.newBuilder("wizardpsidust1", "cyberwizards_seller_1", 100, 0);
...
val wizardpsimetal1 = mods.modularmachinery.RecipeBuilder.newBuilder("wizardpsimetal1", "cyberwizards_seller_1", 100, 0);
...
val wizardsilk1 = mods.modularmachinery.RecipeBuilder.newBuilder("wizardsilk1", "cyberwizards_seller_1", 100, 0);
...
val wizardcrysflower1 = mods.modularmachinery.RecipeBuilder.newBuilder("wizardcrysflower1", "cyberwizards_seller_1", 100, 0);
...
val wizardcrystal1 = mods.modularmachinery.RecipeBuilder.newBuilder("wizardcrystal1", "cyberwizards_seller_1", 100, 0);
...
val wizardscroll1 = mods.modularmachinery.RecipeBuilder.newBuilder("wizardscroll1", "cyberwizards_seller_1", 100, 0);
...
val wizardelecrystal1 = mods.modularmachinery.RecipeBuilder.newBuilder("wizardelecrystal1", "cyberwizards_seller_1", 100, 0);

...
val basicore = [
<minecraft:quartz_ore>, <minecraft:diamond_ore>, <minecraft:redstone_ore>, <minecraft:lapis_ore>, <minecraft:gold_ore>, <minecraft:iron_ore>, <minecraft:coal_ore>, <techguns:basicore:4>, <techguns:basicore:3>, <techguns:basicore:2>, <techguns:basicore:1>, <techguns:basicore>, <armorplus:ore_lava_crystal>
] as IItemStack[];
...
val basicore2 = [
<wearables:wearable_fabricator>, <variedcommodities:carpentry_bench>
] as IItemStack[];

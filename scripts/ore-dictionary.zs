...
for item in colorplastic {
    item.addTooltip(format.gray("Pneumaticraft Plastic - Trade to Labrats"));
...
for item in pneumaticnetwork {
    item.addTooltip(format.gray("Pneumaticraft Network Node - Trade to Labrats"));
...
for item in armorplustrophy {
    item.addTooltip(format.gray("ArmorPlus Trophy - Trade to The Flock."));
...
for item in armorplusultimatepieces {
    item.addTooltip(format.gray("ArmorPlus Armor Piece - Trade to The Flock"));
...
for item in techgunparts {
    item.addTooltip(format.gray("TechGun Part - Trade to The Flock"));
